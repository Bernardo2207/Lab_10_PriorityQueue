...
public class PriorityQueueTester1 {
	...
	public static void main(String[] args) {
		//Answer to Excersice 4
		//Because we change the Compartor the min value will be different,therefore...
		//when we execute removeMin() the value being removed will be different.
		
		//DisplayablePriorityQueue<Integer, String> pq = new UnsortedListPriorityQueue<>(new IntegerComparator2());  //1
		
		//Answer to Excersice 6
				//Because we change the Compartor the min value will be different,therefore...
				//when we execute removeMin() the value being removed will be different.
